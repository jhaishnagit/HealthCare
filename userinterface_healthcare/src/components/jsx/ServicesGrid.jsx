...
const services = [
  { name: "Talk to Doctor", img: talk_ro_doctor, link: "/talkToDoctors" },
  { name: "Medicine", img: Medicine, link: "/medicine" },
  { name: "Book Dr. Appointment", img: appointment_image, link: "/appointment" },
  { name: "Lab Test & Packages", img: lab_test, link: "labtest" },
  { name: "Surgery", img: surgery, link: "Surgery.html" },
  { name: "JhaiHealthcare GOLD", img: "/images/", link: "#" },
