...
/
--------------------------------------------------------
--  DDL for Sequence APPOINTMENTS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."APPOINTMENTS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence BED_BOOKING_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."BED_BOOKING_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence CUSTOMER_ADD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."CUSTOMER_ADD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Sequence MEDICINE_REVIEWS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MEDICINE_REVIEWS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence MEDICINE_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."MEDICINE_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 42 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."PATIENT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence PRESCRIPTION_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."PRESCRIPTION_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SYSTEM"."STAFF_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 81 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Sequence SUPPLIER_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "SYSTEM"."SUPPLIER_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;
--------------------------------------------------------
--  DDL for Table APPOINTMENTS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."APPOINTMENTS" 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table BED_BOOKING
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."BED_BOOKING" 
   (	"BOOKING_ID" NUMBER DEFAULT "SYSTEM"."BED_BOOKING_SEQ"."NEXTVAL", 
	"BED_ID" NUMBER, 
	"PATIENT_ID" NUMBER, 
	"ADMISSION_DATE" DATE DEFAULT CURRENT_TIMESTAMP, 
	"DISCHARGE_DATE" VARCHAR2(30 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUSTOMER_ADDRESSES" 
   (	"ADDRESS_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"USER_ID" NUMBER, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CUSTOMER_CART_ITEMS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUSTOMER_ORDERS" 
   (	"ORDER_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"USER_ID" NUMBER, 
	"ADDRESS_ID" NUMBER, 
	"ORDER_STATUS" VARCHAR2(50 BYTE) DEFAULT 'PENDING', 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table CUSTOMER_ORDER_ITEMS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."CUSTOMER_PAYMENTS" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DOCTORS" 
   (	"DOCTOR_ID" NUMBER, 
	...
	"MEDICAL_LICENSE_NO" VARCHAR2(100 BYTE), 
	"ROLE" VARCHAR2(50 BYTE), 
	"IMAGE" BLOB, 
	"PASSWORD" VARCHAR2(100 BYTE), 
	"ORGANIZATION_ID" NUMBER, 
	"TALK_AVAILABLE" VARCHAR2(10 BYTE) DEFAULT 'NO', 
	"LATITUDE" NUMBER(10,6), 
	"LONGITUDE" NUMBER(10,6), 
	"IMAGE_URL" VARCHAR2(500 BYTE), 
	"CONSULTATION_FEES" NUMBER(10,2)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."DOCTOR_AVAILABILITY" 
   (	"SLOT_ID" NUMBER, 
	"DOCTOR_ID" NUMBER, 
	"SLOT_DATE" DATE, 
	"START_TIME" TIMESTAMP (6), 
	"END_TIME" TIMESTAMP (6), 
	"SLOT_STATUS" VARCHAR2(20 BYTE) DEFAULT 'AVAILABLE', 
...
--------------------------------------------------------
--  DDL for Table HOSPITALS_MEDICALSTORES
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" 
   (	"ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"ESTABLISHED_YEAR" NUMBER(4,0), 
	"OWNERSHIP_TYPE" VARCHAR2(30 BYTE), 
	"ORGANIZATION_MAIL" VARCHAR2(255 BYTE), 
	"HOSPITAL_PHONE" VARCHAR2(10 BYTE), 
	"ALTERNATE_PHONE" VARCHAR2(10 BYTE), 
	...
	"STATE" VARCHAR2(100 BYTE), 
	"COUNTRY" VARCHAR2(100 BYTE) DEFAULT 'India', 
	"PINCODE" VARCHAR2(6 BYTE), 
	"LATITUDE" NUMBER(10,6), 
	"LONGITUDE" NUMBER(10,6), 
	"GEOFENCE_RADIUS" NUMBER DEFAULT 500, 
	"LOCATION_ACCURACY" VARCHAR2(10 BYTE) DEFAULT 'high', 
	"GOOGLE_PLACE_ID" VARCHAR2(255 BYTE), 
	"GOOGLE_MAP_LINK" VARCHAR2(500 BYTE), 
	"TOTAL_BEDS" NUMBER DEFAULT 0, 
	"ICU_BEDS" NUMBER DEFAULT 0, 
	"EMERGENCY_BEDS" NUMBER DEFAULT 0, 
	"OPERATION_THEATRES" NUMBER DEFAULT 0, 
	"VENTILATORS" NUMBER DEFAULT 0, 
	"AMBULANCES" NUMBER DEFAULT 0, 
	"DEPARTMENTS" CLOB, 
	"SERVICES" CLOB, 
	"FACILITIES" CLOB, 
	"DOCUMENTS" CLOB, 
	...
	"GST_NUMBER" VARCHAR2(50 BYTE), 
	"LICENCE_EXPIRY" DATE, 
	"FIRE_SAFETY_VALIDITY" DATE DEFAULT NULL, 
	"INSURANCE_DETAILS" CLOB DEFAULT NULL, 
	"STATUS" VARCHAR2(20 BYTE) DEFAULT 'pending', 
	"VERIFICATION_LEVEL" VARCHAR2(20 BYTE) DEFAULT '1', 
	"REVIEWED_AT" DATE, 
	"REVIEWED_BY" NUMBER, 
	"REJECTION_REASON" CLOB, 
	"ONBOARDING_STAGE" NUMBER DEFAULT 1, 
	"RATING" NUMBER(3,2) DEFAULT 0, 
	"RATING_COUNT" NUMBER DEFAULT 0, 
	"VIEWS" NUMBER DEFAULT 0, 
	"PROFILE_COMPLETION" NUMBER DEFAULT NULL, 
	"SUBMITTED_AT" DATE, 
	"LAST_LOGIN_AT" DATE, 
	"IP_ADDRESS" VARCHAR2(50 BYTE) DEFAULT NULL, 
	"CREATED_AT" DATE DEFAULT SYSDATE, 
	...
	"BANK_HOLDER_NAME" VARCHAR2(150 BYTE), 
	"PASSBOOK_IMAGE" CLOB
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
 ...
 LOB ("ADDRESS") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("DEPARTMENTS") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("SERVICES") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("FACILITIES") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("DOCUMENTS") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
 ...
 LOB ("IMAGES") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("INSURANCE_DETAILS") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("REJECTION_REASON") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) 
 LOB ("PASSBOOK_IMAGE") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table HTE_APPOINTMENTS
--------------------------------------------------------

  CREATE GLOBAL TEMPORARY TABLE "SYSTEM"."HTE_APPOINTMENTS" 
   (	"APPOINTMENT_DATE" DATE, 
	"RN_" NUMBER(10,0), 
	...
	"SLOT_ID" NUMBER(19,0), 
	"USER_ID" NUMBER(19,0), 
	"APPOINTMENT_TIME" VARCHAR2(255 CHAR), 
	"STATUS" VARCHAR2(255 CHAR)
   ) ON COMMIT DELETE ROWS ;
--------------------------------------------------------
--  DDL for Table HTE_DOCTOR_AVAILABILITY
--------------------------------------------------------

  CREATE GLOBAL TEMPORARY TABLE "SYSTEM"."HTE_DOCTOR_AVAILABILITY" 
   (	"RN_" NUMBER(10,0), 
	"SLOT_DATE" DATE, 
	"DOCTOR_ID" NUMBER(19,0), 
	"SLOT_ID" NUMBER(19,0), 
	"END_TIME" VARCHAR2(255 CHAR), 
	"SLOT_STATUS" VARCHAR2(255 CHAR), 
	"START_TIME" VARCHAR2(255 CHAR)
   ) ON COMMIT DELETE ROWS ;
--------------------------------------------------------
--  DDL for Table LAB_CATEGORY
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."LAB_CATEGORY" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LAB_REPORT" 
 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" 
 LOB ("REPORT_FILE") STORE AS BASICFILE (
  TABLESPACE "SYSTEM" ENABLE STORAGE IN ROW CHUNK 8192 RETENTION 
  NOCACHE LOGGING 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table LAB_TEST
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."LAB_TEST" 
   (	"TEST_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"CATEGORY_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."LOGIN_DETAILS" 
   (	"EMAIL" VARCHAR2(100 BYTE), 
	"PASSWORD" VARCHAR2(100 BYTE), 
	"ROLE" VARCHAR2(50 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."MEDICINE" 
   (	"MEDICINE_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 31 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	...
	"STATUS" VARCHAR2(20 BYTE), 
	"LOCATION_OF_RACK" VARCHAR2(150 BYTE), 
	"SUPPLIER_ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table MEDICINE_REVIEWS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."MEDICINE_REVIEWS" 
...
--------------------------------------------------------
--  DDL for Table ORGANIZATION_BANKDETAILS
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" 
   (	"BANK_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ORGANIZATION_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PATIENTS" 
   (	"PATIENT_ID" NUMBER, 
	"NAME" VARCHAR2(100 BYTE), 
	"GENDER" VARCHAR2(10 BYTE), 
	"AADHAR" VARCHAR2(12 BYTE), 
	"PHONE" VARCHAR2(15 BYTE), 
	"DATE_OF_BIRTH" DATE, 
	"ADDRESS" VARCHAR2(255 BYTE), 
	"DOCTOR_ID" NUMBER, 
	"APPOINTMENT_DATE" VARCHAR2(20 BYTE), 
	"APPOINTMENT_TIME" VARCHAR2(20 BYTE), 
	"DISEASE" VARCHAR2(100 BYTE), 
	"DOSAGE_INSTRUCTIONS" VARCHAR2(255 BYTE), 
	"GENERATED_AT" DATE, 
	"NOTES" VARCHAR2(500 BYTE), 
	"SELECTED_MEDICINES" VARCHAR2(500 BYTE), 
	"DATE_ISSUED" DATE, 
	"MEDICATION" VARCHAR2(200 BYTE), 
	"SELECTED_TESTS" VARCHAR2(500 BYTE), 
	"MEDISION_STATUS" VARCHAR2(50 BYTE), 
	"DOCTOR_STATUS" VARCHAR2(50 BYTE), 
	"LAB_STATUS" VARCHAR2(50 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PRESCRIPTION" 
   (	"ID" NUMBER(19,0), 
	"DOCTOR_ID" NUMBER(19,0), 
	"DOSAGE_INSTRUCTIONS" VARCHAR2(255 BYTE), 
	...
	"SELECTED_MEDICINES" VARCHAR2(255 BYTE), 
	"DATE_ISSUED" DATE, 
	"DOSAGE" VARCHAR2(255 BYTE), 
	"MEDICATION" VARCHAR2(255 BYTE), 
	"SELECTED_TESTS" VARCHAR2(255 BYTE)
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."PRESCRIPTIONS" 
   (	"PRESCRIPTION_ID" NUMBER GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"ID" NUMBER, 
	"ORDER_ID" NUMBER, 
	"FILE_URL" VARCHAR2(1000 BYTE), 
	"VERIFICATION_STATUS" VARCHAR2(20 BYTE) DEFAULT 'PENDING', 
	"UPLOADED_ON" DATE DEFAULT SYSDATE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."SUPPLIER_MASTER" 
   (	"SUPPLIER_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 6 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"SUPLIER_NAME" VARCHAR2(100 BYTE), 
	"COMPANY_NAME" VARCHAR2(150 BYTE), 
	"S_EMAIL" VARCHAR2(100 BYTE), 
	"S_CONTACT" VARCHAR2(15 BYTE), 
	"S_STATUS" VARCHAR2(20 BYTE), 
	"SUPALY_DATE" DATE, 
	"CREATED_AT" DATE DEFAULT SYSDATE, 
	"UPDATED_AT" DATE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "SYSTEM"."USER_MASTER" 
   (	"ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"FULL_NAME" VARCHAR2(100 BYTE), 
	...
	"SALARY" NUMBER(10,2), 
	"JOINING_DATE" DATE, 
	"SHIFT_TIMINGS" VARCHAR2(30 BYTE), 
	"IMAGE" BLOB, 
	"LOGIN_ATTEMPTS" NUMBER DEFAULT 0, 
	"PASSWORD" VARCHAR2(255 BYTE), 
	"TWO_FACTOR_AUTHENTICATION" NUMBER(1,0), 
 ...
 LOB ("IMAGE") STORE AS BASICFILE (
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
--------------------------------------------------------
--  DDL for Table WARD_MASTER
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."WARD_MASTER" 
   (	"WARD_ID" NUMBER GENERATED BY DEFAULT AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"WARD_NAME" VARCHAR2(100 BYTE), 
	"WARD_TYPE" VARCHAR2(50 BYTE), 
	"TOTAL_BEDS" NUMBER, 
...
REM INSERTING into SYSTEM.APPOINTMENTS
SET DEFINE OFF;
Insert into SYSTEM.APPOINTMENTS (APPOINTMENT_ID,DOCTOR_ID,SLOT_ID,USER_ID,HOSPITAL_ID,APPOINTMENT_DATE,START_TIME,STATUS,CREATED_AT) values (1,102,1002,1,null,to_date('19-DEC-25','DD-MON-RR'),null,'BOOKED',to_timestamp('19-DEC-25 11.40.52.349546000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.APPOINTMENTS (APPOINTMENT_ID,DOCTOR_ID,SLOT_ID,USER_ID,HOSPITAL_ID,APPOINTMENT_DATE,START_TIME,STATUS,CREATED_AT) values (2,102,1003,1,null,to_date('19-DEC-25','DD-MON-RR'),null,'BOOKED',to_timestamp('19-DEC-25 11.46.51.188034000 AM','DD-MON-RR HH.MI.SSXFF AM'));
Insert into SYSTEM.APPOINTMENTS (APPOINTMENT_ID,DOCTOR_ID,SLOT_ID,USER_ID,HOSPITAL_ID,APPOINTMENT_DATE,START_TIME,STATUS,CREATED_AT) values (21,102,2002,2,null,to_date('20-DEC-25','DD-MON-RR'),to_timestamp('20-DEC-25 10.15.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'BOOKED',to_timestamp('20-DEC-25 11.27.48.447842000 AM','DD-MON-RR HH.MI.SSXFF AM'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.BED_BOOKING
SET DEFINE OFF;
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (1,2,101,to_date('15-OCT-25','DD-MON-RR'),'2025-10-30','Completed',2);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (6,9,null,null,null,'Available',1);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (3,1,null,null,null,'Available',1);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (21,3,3,to_date('30-OCT-25','DD-MON-RR'),'2025-10-31','Active',2);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (23,7,21,to_date('24-OCT-25','DD-MON-RR'),'2025-10-25','Active',2);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (25,6,null,null,null,'Available',1);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (2,1,null,null,null,'Available',2);
Insert into SYSTEM.BED_BOOKING (BOOKING_ID,BED_ID,PATIENT_ID,ADMISSION_DATE,DISCHARGE_DATE,STATUS,WARD_ID) values (27,5,1,to_date('23-OCT-25','DD-MON-RR'),null,'Active',1);
REM INSERTING into SYSTEM.CUSTOMER_ADDRESSES
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_ADDRESSES (ADDRESS_ID,USER_ID,ADDRESS_LINE1,ADDRESS_LINE2,CITY,STATE,PINCODE,LANDMARK,IS_DEFAULT,CREATED_ON) values (1,1,'Flat No 101, Green Apartments','Near Bus Stand','Hyderabad','Telangana','500081','Hitech City',1,to_date('29-DEC-25','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_ADDRESSES (ADDRESS_ID,USER_ID,ADDRESS_LINE1,ADDRESS_LINE2,CITY,STATE,PINCODE,LANDMARK,IS_DEFAULT,CREATED_ON) values (21,1,'Flat No 101','Near Bus Stand','Hyderabad','Telangana','500081','Hitech City',0,to_date('30-DEC-25','DD-MON-RR'));
REM INSERTING into SYSTEM.CUSTOMER_CART
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_CART (CART_ID,USER_ID,CREATED_ON,UPDATED_ON) values (1,1,to_date('23-DEC-25','DD-MON-RR'),to_date('23-DEC-25','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART (CART_ID,USER_ID,CREATED_ON,UPDATED_ON) values (2,10,to_date('23-DEC-25','DD-MON-RR'),null);
REM INSERTING into SYSTEM.CUSTOMER_CART_ITEMS
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (23,2,35,4,6,to_date('30-DEC-25','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (24,2,41,2,7.8,to_date('30-DEC-25','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (25,2,13,1,1.2,to_date('30-DEC-25','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (62,2,5,1,7.8,to_date('03-JAN-26','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (42,2,19,1,12.5,to_date('03-JAN-26','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (61,2,39,1,5,to_date('03-JAN-26','DD-MON-RR'));
Insert into SYSTEM.CUSTOMER_CART_ITEMS (CART_ITEM_ID,CART_ID,ITEM_ID,QUANTITY,PRICE_AT_ADD,ADDED_ON) values (22,2,3,12,5,to_date('30-DEC-25','DD-MON-RR'));
REM INSERTING into SYSTEM.CUSTOMER_ORDERS
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_ORDERS (ORDER_ID,USER_ID,ADDRESS_ID,ORDER_STATUS,TOTAL_AMOUNT,PAYMENT_STATUS,PAYMENT_METHOD,ORDER_DATE,UPDATED_ON) values (1,1,1,'CREATED',450,'PENDING',null,to_date('30-DEC-25','DD-MON-RR'),to_date('30-DEC-25','DD-MON-RR'));
REM INSERTING into SYSTEM.CUSTOMER_ORDER_ITEMS
SET DEFINE OFF;
Insert into SYSTEM.CUSTOMER_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,PRICE_PER_UNIT,SUBTOTAL) values (1,1,1,2,45,90);
Insert into SYSTEM.CUSTOMER_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,PRICE_PER_UNIT,SUBTOTAL) values (2,1,2,1,120,120);
Insert into SYSTEM.CUSTOMER_ORDER_ITEMS (ORDER_ITEM_ID,ORDER_ID,PRODUCT_ID,QUANTITY,PRICE_PER_UNIT,SUBTOTAL) values (3,1,5,2,120,240);
REM INSERTING into SYSTEM.CUSTOMER_PAYMENTS
SET DEFINE OFF;
REM INSERTING into SYSTEM.DOCTORS
SET DEFINE OFF;
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (101,'Dr Ravi Kumar','Cardiologist','9876543010','ravi@gmail.com',12,'ACTIVE','Hyderabad','1985-06-15','Male',null,null,null,null,'MED12345','DOCTOR','test@123',null,'YES',17.385,78.4867,'https://res.cloudinary.com/dvk6mwbht/image/upload/v1765973951/doctors/xyepvpjnv0zobkieah7d.jpg',null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (102,'Dr. Priya Sharma','Dermatology','9876501234','bvamsi313@gmail.com',1,'ACTIVE','5 Gachibowli Main Road, Hyderabad',null,'Female','Hyderabad','Telangana','500032','India','LIC67890','Doctor','11112222',null,'YES',null,null,null,null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (103,'Dr. Rajesh Patel','Orthopedics','9876009876','pavansanthosh733@gmail.com',2,'ACTIVE','22 Ellis Road, Chennai',null,'Male','Chennai','Tamil Nadu','600018','India','LIC99999','Doctor','11112222',null,'YES',null,null,null,null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (104,'Dr. Sneha Reddy','Pediatrics','9876123456','eswarimadhavarapu@gmail.com',6,'ACTIVE','14 Beach Road, Vizag',null,'Female','Visakhapatnam','Andhra Pradesh','530017','India','LIC56789','Doctor','11112222',89,'YES',null,null,null,null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (108,'Vamsi bvamsi','Neurologist','76869899','bvamsi@gmail.com',3,'Active','wertyjhcvbk','2012-06-08','Male',null,null,null,null,'1111112222222','Doctor','11112222',null,'YES',null,null,null,null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (107,'Dr. Anil Kumar','Cardiology','9876542210','an.kumar@example.com',12,'ACTIVE','12 MG Road, Vijayawada',null,'Male','Vijayawada','Andhra Pradesh','520010','India','LIC1wq2345','Doctor','password123',null,'NO',null,null,null,null);
Insert into SYSTEM.DOCTORS (DOCTOR_ID,DOCTOR_NAME,SPECIALIZATION,PHONE,EMAIL,EXPERIENCE,STATUS,ADDRESS,DATE_OF_BIRTH,GENDER,CITY,STATE,PIN_CODE,COUNTRY,MEDICAL_LICENSE_NO,ROLE,PASSWORD,ORGANIZATION_ID,TALK_AVAILABLE,LATITUDE,LONGITUDE,IMAGE_URL,CONSULTATION_FEES) values (109,'Dr.ail Kumar','Cardiology','9876442210','kumarmar@exmple.com',12,'ACTIVE','12 MG Road, Vijayawada',null,'Male','Vijayawada','Andhra Pradesh','520010','India','wq2345','Doctor','password123',null,'NO',null,null,null,null);
REM INSERTING into SYSTEM.DOCTOR_AVAILABILITY
SET DEFINE OFF;
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1001,102,to_date('19-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1002,102,to_date('19-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1003,102,to_date('19-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1004,102,to_date('20-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1005,102,to_date('20-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1006,102,to_date('21-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (1007,102,to_date('21-DEC-25','DD-MON-RR'),null,null,'EXPIRED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (2001,102,to_date('20-DEC-25','DD-MON-RR'),to_timestamp('20-DEC-25 10.00.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),null,'AVAILABLE',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (2002,102,to_date('20-DEC-25','DD-MON-RR'),to_timestamp('20-DEC-25 10.15.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),null,'BOOKED',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (2003,102,to_date('20-DEC-25','DD-MON-RR'),to_timestamp('20-DEC-25 10.30.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),null,'AVAILABLE',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (2004,102,to_date('21-DEC-25','DD-MON-RR'),to_timestamp('21-DEC-25 11.00.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),null,'AVAILABLE',to_date('19-DEC-25','DD-MON-RR'));
Insert into SYSTEM.DOCTOR_AVAILABILITY (SLOT_ID,DOCTOR_ID,SLOT_DATE,START_TIME,END_TIME,SLOT_STATUS,CREATED_AT) values (4001,102,to_date('20-DEC-25','DD-MON-RR'),to_timestamp('20-DEC-25 10.00.00.000000000 AM','DD-MON-RR HH.MI.SSXFF AM'),null,'AVAILABLE',to_date('20-DEC-25','DD-MON-RR'));
...
REM INSERTING into SYSTEM.HOSPITALS_MEDICALSTORES
SET DEFINE OFF;
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (244,'HSP008','appollo','Hospital','Super Specialty',0,null,'hjhddsgh@gmail.com','7856523362',null,null,null,null,'Visakhapatnam',null,'Andhra Pradesh','India','520001',16.501625,80.64994,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (245,'CLC008','hgdgd','Clinic',null,0,null,'hjsdghs@gmail.com','6789068790',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501627,80.649938,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (105,'HSP014','hfahfa','Hospital','Multi-Specialty',0,'Private','hfdafaj@gmail.com','7836763278',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,500,'high',null,null,0,0,0,0,0,0,null,null,null,null,'Approved','2',null,null,2,null,null,null,null,null,null,null,null,null,'82532726182588','SBIN0001234','Guntur','SBI','gfghhjjk');
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (247,'HSP015','noha','Hospital','Multi-Specialty',0,null,'bhavanigojula2001@gmail.com','8895434535',null,null,null,null,'Guntur',null,'Andhra Pradesh','India','520001',16.300699,80.446873,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (83,'HSP007','hgdssjkd','Hospital','Multi-Specialty',0,'Private','dasgfas@gmail.com','4517316716',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,500,'high',null,null,0,0,0,0,0,0,null,null,null,null,'pending','0',null,null,1,0,0,0,0,to_date('26-NOV-25','DD-MON-RR'),to_date('26-NOV-25','DD-MON-RR'),null,to_date('26-NOV-25','DD-MON-RR'),to_date('26-NOV-25','DD-MON-RR'),null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (89,'HSP005','ghdjkd','Hospital','Multi-Specialty',0,'Private','gfsahjas@gmail.com','7854743565',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.870084,82.114409,500,'high',null,null,0,0,0,0,0,0,null,null,null,null,'Approved','2',null,null,1,0,0,0,0,to_date('26-NOV-25','DD-MON-RR'),to_date('26-NOV-25','DD-MON-RR'),null,to_date('26-NOV-25','DD-MON-RR'),to_date('26-NOV-25','DD-MON-RR'),null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (227,'HSP010','hjasghgasf','Hospital','Super Specialty',0,null,'monikanagaswathikadali@gmail.com','9987654434',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'pending','0',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (228,'HSP011','hjhggff','Hospital','Clinic',0,null,'swathikadali32567@gmail.com','9666584158',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (231,'CLC011','prasadh','Clinic',null,0,null,'nagaswathikadali@gmail.com','9666584155',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (232,'DOC017','hhjjkjkh','IndividualDoctor','IndividualDoctor',0,null,'hgafdfa@gmail.com','9882162412',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','521137',0,0,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (234,'HSP019','monikaaaa','Hospital','Multi-Specialty',0,null,'nagahikadali@gmail.com','9666825367',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (235,'HSP029','fgsfdsfs','Hospital','Nursing Home',0,null,'hswgfsf@gmail.com','9564542452',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'pending','0',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (236,'HSP030','SwathiKadali','Hospital','General Hospital',0,null,'kadaliswathi@gmail.com','9703576135','9888584155',null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.649895,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,'825327261823445361','SBIN0003614','kadapa','SBI','jhsahghfa');
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (243,'HSP022','kims','Hospital','Super Specialty',0,null,'nidubrolupavan@gmail.com','6453161788','8126552161',null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501625,80.64994,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'Approved','2',null,null,3,null,null,null,null,null,null,null,null,null,'654338886543333333','SBIN0008744','Guntur','SBI','bhavani');
Insert into SYSTEM.HOSPITALS_MEDICALSTORES (ID,CODE,NAME,TYPE,TAGLINE,ESTABLISHED_YEAR,OWNERSHIP_TYPE,ORGANIZATION_MAIL,HOSPITAL_PHONE,ALTERNATE_PHONE,WEBSITE,LANDMARK,AREA,CITY,DISTRICT,STATE,COUNTRY,PINCODE,LATITUDE,LONGITUDE,GEOFENCE_RADIUS,LOCATION_ACCURACY,GOOGLE_PLACE_ID,GOOGLE_MAP_LINK,TOTAL_BEDS,ICU_BEDS,EMERGENCY_BEDS,OPERATION_THEATRES,VENTILATORS,AMBULANCES,REGISTRATION_NUMBER,GST_NUMBER,LICENCE_EXPIRY,FIRE_SAFETY_VALIDITY,STATUS,VERIFICATION_LEVEL,REVIEWED_AT,REVIEWED_BY,ONBOARDING_STAGE,RATING,RATING_COUNT,VIEWS,PROFILE_COMPLETION,SUBMITTED_AT,LAST_LOGIN_AT,IP_ADDRESS,CREATED_AT,UPDATED_AT,ACCOUNT_NO,IFSC_CODE,BRANCH_NAME,BANK_NAME,BANK_HOLDER_NAME) values (222,'HSP009','hgshssh','Hospital','General Hospital',0,null,'kjdgfhghhg@gmail.com','9987654545',null,null,null,null,'Vijayawada',null,'Andhra Pradesh','India','520001',16.501473,80.64986,null,null,null,null,null,null,null,null,null,null,null,null,null,null,'pending','0',null,null,3,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
REM INSERTING into SYSTEM.HTE_APPOINTMENTS
SET DEFINE OFF;
REM INSERTING into SYSTEM.HTE_DOCTOR_AVAILABILITY
SET DEFINE OFF;
REM INSERTING into SYSTEM.LAB_CATEGORY
SET DEFINE OFF;
Insert into SYSTEM.LAB_CATEGORY (CATEGORY_ID,CATEGORY_NAME) values (1,'Scaning');
Insert into SYSTEM.LAB_CATEGORY (CATEGORY_ID,CATEGORY_NAME) values (2,'X-Ray');
Insert into SYSTEM.LAB_CATEGORY (CATEGORY_ID,CATEGORY_NAME) values (3,'MRI');
Insert into SYSTEM.LAB_CATEGORY (CATEGORY_ID,CATEGORY_NAME) values (4,'Urine Test');
Insert into SYSTEM.LAB_CATEGORY (CATEGORY_ID,CATEGORY_NAME) values (5,'Cardiac/ECG');
REM INSERTING into SYSTEM.LAB_REPORT
SET DEFINE OFF;
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (1,23,1,'linuxcommands.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (2,2,2,'platelet_ravi_101.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (3,4,7,'mri_sita_102.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (4,3,1,'sugar_arjun_103.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (5,5,9,'urine_lakshmi_104.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (6,6,5,'xray_kiran_105.png','image/png',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (7,7,3,'hemoglobin_priya_106.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (8,9,9,'urine_rahul_107.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (9,13,4,'cholesterol_sneha_108.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (10,11,10,'ecg_ramesh_109.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (12,505,1,'AfreedResumeAI&Annotation.pdf','application/pdf',to_date('11-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (21,3,5,'AfreedResumeAI&Annotation.pdf','application/pdf',to_date('13-NOV-25','DD-MON-RR'));
Insert into SYSTEM.LAB_REPORT (REPORT_ID,PATIENT_ID,TEST_ID,FILE_NAME,FILE_TYPE,UPLOADED_ON) values (41,4,8,'download.jpg','image/jpeg',to_date('20-NOV-25','DD-MON-RR'));
REM INSERTING into SYSTEM.LAB_TEST
SET DEFINE OFF;
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (1,1,'Sugar Level',158);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (2,1,'Platelet Count',250);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (3,1,'Hemoglobin',100);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (4,1,'Cholesterol',250);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (5,2,'Chest X-Ray',800);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (6,2,'Spine X-Ray',950);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (7,3,'Brain MRI',2500);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (8,3,'Spine MRI',2800);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (9,4,'Urine Routine',200);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (10,5,'ECG',600);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (11,1,'Platelet Count',200);
Insert into SYSTEM.LAB_TEST (TEST_ID,CATEGORY_ID,TEST_NAME,TEST_COST) values (23,1,'blood test',100);
REM INSERTING into SYSTEM.LOGIN_DETAILS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.MEDICINE
SET DEFINE OFF;
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (1,'Dolo (500mg)','Tablet','Micro Labs Ltd','DL500A',5,2.8,5,50,to_date('10-MAY-27','DD-MON-RR'),'Pain and fever relief','Active','Rack-A1',1,'Admin','admin',to_date('28-OCT-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,null,'https://res.cloudinary.com/dvk6mwbht/image/upload/v1765189506/medicines/iq5abudymo9i1vnzt4qp.jpg');
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (2,'Paracetamol (650mg)','Tablet','Cipla Ltd','P650B',2.9,2.4,300,60,to_date('30-NOV-26','DD-MON-RR'),'Common fever reducer','Active','Rack-A2',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),105,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (3,'Amoxicillin (250mg)','Capsule','GSK Pharma','AMX250C',5,4.2,120,20,to_date('12-OCT-25','DD-MON-RR'),'Antibiotic for infections','Active','Rack-B1',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),105,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (4,'Cetrizine (10mg)','Tablet','Dr. Reddy Labs','CTZ10D',1.5,1.2,600,80,to_date('01-SEP-27','DD-MON-RR'),'Allergy and cold relief','Active','Rack-A3',3,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),105,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (5,'Azithromycin (500mg)','Tablet','Cipla Ltd','AZ500E',7.8,6.2,150,25,to_date('15-APR-26','DD-MON-RR'),'Bacterial infection treatment','Active','Rack-B2',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,null,'https://res.cloudinary.com/dvk6mwbht/image/upload/v1765188924/medicines/puqcygshytiu6flz0rl2.jpg');
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (7,'Crocin (500mg)','Tablet','GlaxoSmithKline','CRC500G',3.2,2.6,200,50,to_date('01-JAN-27','DD-MON-RR'),'Pain and fever relief','Active','Rack-A4',4,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),105,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (9,'Pantoprazole (40mg)','Tablet','Sun Pharma','PTZ40H',4.2,3.7,220,40,to_date('11-SEP-25','DD-MON-RR'),'Acidity control','Active','Rack-A5',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),105,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (10,'Metformin (500mg)','Tablet','Torrent Pharma','MTF500I',2.5,2.1,310,70,to_date('25-SEP-26','DD-MON-RR'),'Diabetes control','Active','Rack-A6',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (11,'Calpol (500mg)','Tablet','GSK Pharma','CLP500J',3.1,2.7,280,60,to_date('12-JUN-26','DD-MON-RR'),'Fever reducer','Active','Rack-A7',3,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (12,'Dextromethorphan (10ml)','Syrup','Pfizer','DXM10K',75,60,70,10,to_date('20-DEC-25','DD-MON-RR'),'Cough suppressant','Active','Rack-D2',4,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (13,'Cetirizine (5mg)','Tablet','Dr. Reddy Labs','CTRZ5L',1.2,0.9,450,80,to_date('01-OCT-27','DD-MON-RR'),'Allergy relief','Active','Rack-B3',5,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (14,'Becozym (100mg)','Tablet','Zydus Healthcare','BCZ100M',6.5,5.1,110,25,to_date('15-FEB-26','DD-MON-RR'),'Vitamin supplement','Active','Rack-C2',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (15,'Insulin (100IU)','Injection','Novo Nordisk','INS100N',130,110,60,15,to_date('30-NOV-25','DD-MON-RR'),'Diabetes control injection','Active','Rack-E1',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (16,'ORS (200ml)','Solution','FDC Ltd','ORS200O',25,20,200,30,to_date('01-JUL-28','DD-MON-RR'),'Rehydration solution','Active','Rack-F1',3,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (17,'Zincovit (15mg)','Tablet','Apex Labs','ZNCT15P',5.5,4.2,150,25,to_date('10-MAY-26','DD-MON-RR'),'Multivitamin supplement','Active','Rack-B4',4,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (18,'Amoxycillin (500mg)','Capsule','Abbott','AMX500Q',7.2,6,100,20,to_date('03-MAR-26','DD-MON-RR'),'Antibiotic','Active','Rack-B5',5,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (19,'Augmentin (625mg)','Tablet','GSK Pharma','AUG625R',12.5,10.2,90,15,to_date('15-AUG-26','DD-MON-RR'),'Antibiotic combination','Active','Rack-B6',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (20,'Norfloxacin (400mg)','Tablet','Cipla Ltd','NRF400S',8.5,7.1,130,20,to_date('12-DEC-26','DD-MON-RR'),'Urinary tract infections','Inactive','Rack-C3',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (21,'Omeprazole (20mg)','Capsule','Dr. Reddy Labs','OMP20T',3.6,3,200,40,to_date('10-SEP-27','DD-MON-RR'),'Acidity control','Active','Rack-C4',3,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (22,'Domperidone (10mg)','Tablet','Zydus Pharma','DMP10U',4.5,3.7,190,35,to_date('07-JUL-26','DD-MON-RR'),'Vomiting control','Active','Rack-D3',4,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (23,'Losartan (50mg)','Tablet','Cipla Ltd','LSR50V',6,5.1,210,30,to_date('20-MAY-26','DD-MON-RR'),'Blood pressure control','Active','Rack-D4',5,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (24,'Telma (40mg)','Tablet','Glenmark','TLM40W',7.2,6,150,20,to_date('04-APR-27','DD-MON-RR'),'BP medicine','Active','Rack-D5',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (25,'Atorvastatin (10mg)','Tablet','Sun Pharma','ATV10X',8,6.8,120,25,to_date('30-JUN-26','DD-MON-RR'),'Cholesterol control','Active','Rack-D6',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (26,'Betadine (50ml)','Solution','Win-Medicare','BTD50Y',45,39,85,15,to_date('01-JAN-28','DD-MON-RR'),'Antiseptic solution','Active','Rack-E2',3,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (27,'Becosules (100mg)','Capsule','Pfizer','BCS100Z',7,6,130,30,to_date('10-OCT-27','DD-MON-RR'),'Vitamin supplement','Active','Rack-E3',4,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (28,'Dexamethasone (4mg)','Injection','Zydus Pharma','DXM4A1',15,12.5,70,10,to_date('01-DEC-25','DD-MON-RR'),'Anti-inflammatory','Active','Rack-E4',5,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (29,'Ciprofloxacin (500mg)','Tablet','Cipla Ltd','CIP500A2',10,8.2,140,20,to_date('08-AUG-26','DD-MON-RR'),'Antibiotic','Inactive','Rack-F2',1,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (30,'Dolo (650mg)','Tablet','Micro Labs Ltd','DL650A3',4,3.2,260,50,to_date('15-JUN-27','DD-MON-RR'),'Pain and fever relief (extra power)','Active','Rack-F3',2,'Admin','Admin',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),89,null,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (33,'Paracetamol','Tablet','Cipla','BAT001',12.5,8,120,20,to_date('10-MAY-26','DD-MON-RR'),'Pain Relief','ACTIVE','Rack-1',1,null,null,to_date('25-NOV-25','DD-MON-RR'),null,89,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (34,'Dolo 650','Tablet','Micro Labs','DL650A',4,2,100,20,to_date('20-NOV-25','DD-MON-RR'),'Fever / Pain relief','Active','Rack A1',3,null,null,to_date('03-DEC-25','DD-MON-RR'),to_date('03-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (35,'Amoxicillin 500mg','Capsule','Cipla','AMX500B',6,4.2,50,15,to_date('05-JAN-26','DD-MON-RR'),'Antibiotic','Active','Rack B2',3,null,null,to_date('03-DEC-25','DD-MON-RR'),to_date('03-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (36,'Paracetamol 500mg','Tablet','Sun Pharma','PARA500X',56,1.8,10,5,to_date('15-AUG-25','DD-MON-RR'),'Pain & Fever','Active','Rack C3',3,null,null,to_date('03-DEC-25','DD-MON-RR'),to_date('03-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (37,'Vitamin C 1000mg','Tablet','Nutra Health','VITC100',8.5,6,0,10,to_date('30-DEC-24','DD-MON-RR'),'Immunity Booster','Inactive','Rack D4',3,null,null,to_date('03-DEC-25','DD-MON-RR'),to_date('03-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (38,'Paracetamol','Tablet','Cipla','PCM650-B1',2.5,1.8,300,50,to_date('31-DEC-26','DD-MON-RR'),'Fever & pain relief','Active','A1',1,null,null,to_date('08-DEC-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (39,'Amoxicillin','Capsule','Sun Pharma','AMX250-B2',5,3.6,120,40,to_date('15-AUG-26','DD-MON-RR'),'Antibiotic','Active','B2',1,null,null,to_date('08-DEC-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (40,'Cetirizine','Tablet','Dr Reddy','CET10-C3',1.5,1,600,100,to_date('20-MAR-26','DD-MON-RR'),'Allergy tablet','Active','C3',1,null,null,to_date('08-DEC-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,1,null);
Insert into SYSTEM.MEDICINE (MEDICINE_ID,MEDICINE_NAME,CATEGORY,MANUFACTURER,BATCH_NO,PRICE_PER_UNIT,PURCHASE_COST,QUANTITY_AVAILABLE,REORDER_LEVEL,EXPIRY_DATE,DESCRIPTION,STATUS,LOCATION_OF_RACK,SUPPLIER_ID,CREATED_BY,UPDATED_BY,CREATED_AT,UPDATED_AT,ORGANIZATION_ID,PERSON_ID,IMAGE_URL) values (41,'Azithromycin','Tablet','Cipla','AZ500-D4',7.8,6.2,150,30,to_date('10-JAN-27','DD-MON-RR'),'Infection medicine','Active','D1',1,null,null,to_date('08-DEC-25','DD-MON-RR'),to_date('08-DEC-25','DD-MON-RR'),105,1,null);
REM INSERTING into SYSTEM.MEDICINE_REVIEWS
SET DEFINE OFF;
Insert into SYSTEM.MEDICINE_REVIEWS (REVIEW_ID,ID,MEDICINE_ID,RATING,CREATED_ON) values (2,7,1,5,to_date('12-DEC-25','DD-MON-RR'));
Insert into SYSTEM.MEDICINE_REVIEWS (REVIEW_ID,ID,MEDICINE_ID,RATING,CREATED_ON) values (3,1,1,5,to_date('12-DEC-25','DD-MON-RR'));
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.ORGANIZATION_BANKDETAILS
SET DEFINE OFF;
REM INSERTING into SYSTEM.PATIENTS
SET DEFINE OFF;
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (23,'Priya Sharma','Female',null,'5426216838',null,'Gandhi Nagar, Vijayawada',103,'1-NOV-25','17:54:40.459674200',null,null,null,null,null,null,null,null,null,null,'Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (2,'Priya Verma','Female','876543210987','8765432109',to_date('22-SEP-95','DD-MON-RR'),'Hyderabad, Telangana',102,'1-NOV-25',null,null,null,null,null,null,to_date('14-NOV-25','DD-MON-RR'),null,null,null,'Completed',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (3,'Vamsi B','Male','123412341235','9876543210',to_date('15-AUG-95','DD-MON-RR'),'Hyderabad, Telangana, India',1,'1-NOV-25',null,null,null,null,null,null,to_date('14-NOV-25','DD-MON-RR'),null,null,null,'pending',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (4,'haritha','Female','992881287988','76869899',to_date('18-JUN-03','DD-MON-RR'),'wertyjhcvbk',108,'1-NOV-25',null,null,null,null,null,null,null,null,null,null,'pending',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (5,'vishnavi','Female','992881287323','76869899',to_date('18-JUN-03','DD-MON-RR'),'wertyjhcvbk',108,'1-NOV-25',null,null,null,null,null,null,null,null,null,null,'pending',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (7,'Rahul Singh','Male','123456789017','9876543217',to_date('22-JUN-85','DD-MON-RR'),'Vijayawada, Andhra Pradesh',107,'5-NOV-25','09:00 AM','Back Pain','Physiotherapy daily',to_date('27-OCT-25','DD-MON-RR'),null,'Painkiller',null,null,'MRI','Issued','Completed','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (9,'Vamsi Krishna','Male','123456789019','9876543219',to_date('09-SEP-96','DD-MON-RR'),'Vijayawada',109,'5-NOV-25','05:15 PM','Fever','Take rest',null,'High temperature','Dolo 650',to_date('27-OCT-25','DD-MON-RR'),'Tablet','Blood Test','Completed','Pending','Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (11,'Ajay Patel','Male',null,'9876543220',to_date('10-JUL-90','DD-MON-RR'),'Ahmedabad',108,'5-NOV-25','02:00 PM','Fever','Take medicine after meal',to_date('27-OCT-25','DD-MON-RR'),null,'Paracetamol',null,null,null,'Completed','Completed','Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (13,'Anjali Gupta','Female','123456789022','9876543222',to_date('16-MAR-91','DD-MON-RR'),'Lucknow',113,'5-NOV-25','07:00 PM','Headache','Drink water',null,'Mild pain','Crocin',null,null,null,'Completed','Completed','Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (14,'Surya Teja','Male','123456789023','9876543223',to_date('25-MAY-95','DD-MON-RR'),'Hyderabad',114,'5-NOV-25','01:30 PM','Cough','Avoid cold drinks',null,null,'Cough Syrup',null,null,'X-Ray','Pending','Pending','Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (15,'Mounika Devi',null,null,null,null,null,115,'10-NOV-25','08:18','Allergy',null,null,'Skin rash',null,null,null,null,null,'Completed',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (18,'Sai Charan','Male','123456789027','9876543227',to_date('28-FEB-87','DD-MON-RR'),'Hyderabad',118,'10-NOV-25','10:15 AM','Injury','Change dressing daily',to_date('27-OCT-25','DD-MON-RR'),null,null,to_date('27-OCT-25','DD-MON-RR'),null,null,'Pending','Completed','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (6,'Meena Lakshmi','Female','999988887777','9700000001',to_date('12-NOV-93','DD-MON-RR'),'Bangalore',106,'10-NOV-25','05:00 PM','Flu','2 times daily',to_date('27-OCT-25','DD-MON-RR'),null,'Fluticasone',to_date('27-OCT-25','DD-MON-RR'),'Tablet','Blood Test','Pending','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (8,'Anita Rao','Female',null,'9800001111',to_date('10-JAN-99','DD-MON-RR'),'Vijayawada',108,'10-NOV-25','09:00 AM','Fever',null,to_date('27-OCT-25','DD-MON-RR'),null,'Paracetamol',to_date('27-OCT-25','DD-MON-RR'),'Tablet',null,'Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (10,'Divya Nair','Female','222233334444','9080706050',to_date('22-MAY-97','DD-MON-RR'),'Kochi',110,'10-NOV-25','12:15 PM','Cold','Twice daily',to_date('27-OCT-25','DD-MON-RR'),'Common cold','D Cold',to_date('27-OCT-25','DD-MON-RR'),'Tablet','None','Issued','Completed','Completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (12,'Kavya Rani','Female','999900001111','9011112233',to_date('05-OCT-00','DD-MON-RR'),'Chennai',112,'10-NOV-25','03:00 PM','Infection','After meals',to_date('27-OCT-25','DD-MON-RR'),null,'Amoxicillin',to_date('27-OCT-25','DD-MON-RR'),'Capsule','Urine Test','Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (16,'Sravani','Female',null,'9500001112',to_date('12-APR-96','DD-MON-RR'),'Hyderabad',116,'10-NOV-25','09:30 AM','Fever',null,to_date('27-OCT-25','DD-MON-RR'),null,'Dolo 650',to_date('27-OCT-25','DD-MON-RR'),'Tablet',null,'Completed','Pending','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (17,'Ganesh','Male',null,'9900012345',to_date('18-FEB-87','DD-MON-RR'),'Chennai',117,'10-NOV-25','08:45 AM','Flu',null,to_date('27-OCT-25','DD-MON-RR'),null,'Fluticasone',to_date('27-OCT-25','DD-MON-RR'),'Tablet',null,'Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (19,'Ramesh','Male',null,'9810002223',to_date('30-NOV-79','DD-MON-RR'),'Pune',119,'10-NOV-25','03:30 PM','Fever',null,to_date('27-OCT-25','DD-MON-RR'),null,'Paracetamol',to_date('27-OCT-25','DD-MON-RR'),'Tablet','Blood Test','Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (20,'Pooja','Female','111144445555','9876540000',to_date('01-JAN-98','DD-MON-RR'),'Hyderabad',120,'12-NOV-25','04:00 PM','Cold',null,to_date('27-OCT-25','DD-MON-RR'),null,'D Cold',to_date('27-OCT-25','DD-MON-RR'),'Tablet',null,'Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (33,'Lalitha','Female','666677778888','9876123450',to_date('09-SEP-90','DD-MON-RR'),'Bangalore',118,'12-NOV-25','10:00 AM','Allergy',null,to_date('27-OCT-25','DD-MON-RR'),null,'Cetirizine',to_date('27-OCT-25','DD-MON-RR'),'Tablet','Allergy Test','Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (30,'Mahesh Babu','Male','555544443333','9701234567',to_date('25-JUN-89','DD-MON-RR'),'Vijayawada',115,'12-NOV-25','10:30 AM','Body Pain','Night only',to_date('27-OCT-25','DD-MON-RR'),'Follow-up needed','Painkiller',to_date('27-OCT-25','DD-MON-RR'),'Tablet','MRI','Pending','Checked','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (35,'Rohit Mehta','Male',null,'9870006543',to_date('09-NOV-91','DD-MON-RR'),'Delhi',113,'12-NOV-25','05:45 PM','Cough','Once a day',to_date('27-OCT-25','DD-MON-RR'),null,'Benadryl',to_date('27-OCT-25','DD-MON-RR'),'Syrup','None','Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (34,'Swathi R','Female','123123123123','9873216540',to_date('30-JUL-94','DD-MON-RR'),'Hyderabad',114,'12-NOV-25','02:00 PM','Cold',null,to_date('27-OCT-25','DD-MON-RR'),null,'D Cold',to_date('27-OCT-25','DD-MON-RR'),'Tablet','X-Ray','Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (36,'Surya Teja','Male',null,'9123450000',to_date('15-AUG-99','DD-MON-RR'),'Vijayawada',108,'14-NOV-25','11:45 AM','Fever','2 per day',to_date('27-OCT-25','DD-MON-RR'),null,'Paracetamol',to_date('27-OCT-25','DD-MON-RR'),'Tablet','CBC','Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (38,'Vijay Kumar','Male','111133335555','9998887776',to_date('30-DEC-80','DD-MON-RR'),'Mumbai',109,'14-NOV-25','01:30 PM','Diabetes','Morning before food',to_date('27-OCT-25','DD-MON-RR'),null,'Metformin',to_date('27-OCT-25','DD-MON-RR'),'Tablet','Blood Sugar','Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (39,'Kiran Patel','Male','123443211234','9871112223',to_date('01-APR-98','DD-MON-RR'),'Pune',107,'14-NOV-25','06:00 PM','Back Pain','Morning only',to_date('27-OCT-25','DD-MON-RR'),'Physio required','Painkiller',to_date('27-OCT-25','DD-MON-RR'),'Tablet','MRI','Completed','Checked','Done');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (24,'vishnavi','Male',null,null,null,'wertyjhcvbk',null,'14-NOV-25','17:59:32.832847400',null,null,null,null,null,null,null,null,null,'pending',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (41,'sunil','Female',null,null,null,'wertyjhcvbk',null,'14-NOV-25','14:07:37.674721600',null,null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (61,'Johnathan','Male',null,null,null,'Guntur, AP',null,'14-NOV-25','14:21:38.512308600',null,null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (81,'kachana','Male',null,null,null,'wertyjhcvbk',null,'14-NOV-25','00:20:01.320877400','heakw vcej',null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (82,'kachana','Male',null,null,null,'wertyjhcvbk',null,'14-NOV-25','00:57:18.812599800','heakw vcej',null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (83,'kalpana','Male',null,null,null,'wertyjhcvbk',null,'14-NOV-25','01:21:54.258689600','heakw vcej',null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (84,'kalpana','Male',null,null,null,'wertyjhcvbk',null,'14-NOV-25','01:23:45.725143900','heakw vcej',null,null,null,null,null,null,null,null,'compleated',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (501,'Ramesh Kumar','Male',null,'9876543210',null,null,null,'14-NOV-25',null,'Fever',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,'given','pending','urgent');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (502,'Sita Devi','Female',null,'9876501234',null,null,null,'14-NOV-25',null,'Cold',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,'pending','checked','pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (503,'Arun Patel','Male',null,'9998877665',null,null,null,'14-NOV-25',null,'Cough',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,'done','checked','completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (504,'Ramesh Kumar','Male',null,'9876543210',null,null,null,'13-NOV-25',null,'Fever',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,null,'completed','urgent');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (505,'Sita Devi','Female',null,'9988776655',null,null,null,'13-NOV-25',null,'Cold',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,null,'completed','pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (506,'Arun Patel','Male',null,'9876501234',null,null,null,'13-NOV-25',null,'Cough',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,null,'completed','completed');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (507,'Vijaya Rao','Female',null,'9012345678',null,null,null,'13-NOV-25',null,'Headache',null,null,null,null,to_date('13-NOV-25','DD-MON-RR'),null,null,null,'completed','urgent');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (101,'kachana','Male',null,null,null,'wertyjhcvbk',null,'13-NOV-25','15:42:01.302371400','heakw vcej',null,null,null,null,null,null,null,null,'completed',null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (123,'haritha','Male','992881287982','76869899',to_date('14-NOV-25','DD-MON-RR'),'wertyjhcvbk',103,'13-NOV-25','12:41','heakw vcej',null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (124,'vishnavi','Female','992881287984','76869899',to_date('12-NOV-25','DD-MON-RR'),'wertyjhcvbk',103,'21-NOV-25','13:51','heakw vcej',null,null,null,null,null,null,null,null,null,null);
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (125,'sunil','Male','992881287324','76869899',to_date('07-NOV-25','DD-MON-RR'),'wertyjhcvbk',108,'15-NOV-25','13:41','heakw vcej',null,null,null,null,to_date('15-NOV-25','DD-MON-RR'),null,null,'Pending','Pending','Pending');
Insert into SYSTEM.PATIENTS (PATIENT_ID,NAME,GENDER,AADHAR,PHONE,DATE_OF_BIRTH,ADDRESS,DOCTOR_ID,APPOINTMENT_DATE,APPOINTMENT_TIME,DISEASE,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,SELECTED_MEDICINES,DATE_ISSUED,MEDICATION,SELECTED_TESTS,MEDISION_STATUS,DOCTOR_STATUS,LAB_STATUS) values (128,'tra','Male','992881287343','76869899',to_date('07-NOV-25','DD-MON-RR'),'Vijayawada, AP',104,'15-NOV-25','12:50','heakw vcej',null,null,null,null,to_date('15-NOV-25','DD-MON-RR'),null,null,'Pending','Pending','Pending');
REM INSERTING into SYSTEM.PRESCRIPTION
SET DEFINE OFF;
Insert into SYSTEM.PRESCRIPTION (ID,DOCTOR_ID,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,PATIENT_ID,SELECTED_MEDICINES,DATE_ISSUED,DOSAGE,MEDICATION,SELECTED_TESTS) values (1,101,'Take 1 tablet twice daily after meals',to_timestamp('13-NOV-25 10.42.46.375000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Patient recovering well',501,'Paracetamol, Amoxicillin',to_date('13-NOV-25','DD-MON-RR'),'500mg','Amoxicillin','Blood Test, X-Ray');
Insert into SYSTEM.PRESCRIPTION (ID,DOCTOR_ID,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,PATIENT_ID,SELECTED_MEDICINES,DATE_ISSUED,DOSAGE,MEDICATION,SELECTED_TESTS) values (2,102,'Take 2 spoons before food',to_timestamp('13-NOV-25 10.42.46.385000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Check sugar level next week',502,'Metformin, Vitamin B12',to_date('13-NOV-25','DD-MON-RR'),'1000mg','Metformin','Blood Sugar Test');
Insert into SYSTEM.PRESCRIPTION (ID,DOCTOR_ID,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,PATIENT_ID,SELECTED_MEDICINES,DATE_ISSUED,DOSAGE,MEDICATION,SELECTED_TESTS) values (3,201,'Take 1 tablet after lunch',to_timestamp('13-NOV-25 11.25.46.668000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Patient needs rest',504,'Paracetamol',to_date('13-NOV-25','DD-MON-RR'),'500mg','Paracetamol','Blood Test');
Insert into SYSTEM.PRESCRIPTION (ID,DOCTOR_ID,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,PATIENT_ID,SELECTED_MEDICINES,DATE_ISSUED,DOSAGE,MEDICATION,SELECTED_TESTS) values (4,202,'Take syrup twice daily',to_timestamp('13-NOV-25 11.25.46.679000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Cough persists',505,'Benadryl',to_date('13-NOV-25','DD-MON-RR'),'10ml','Benadryl','X-Ray');
Insert into SYSTEM.PRESCRIPTION (ID,DOCTOR_ID,DOSAGE_INSTRUCTIONS,GENERATED_AT,NOTES,PATIENT_ID,SELECTED_MEDICINES,DATE_ISSUED,DOSAGE,MEDICATION,SELECTED_TESTS) values (5,203,'Take 1 tablet before bed',to_timestamp('13-NOV-25 11.25.46.686000000 AM','DD-MON-RR HH.MI.SSXFF AM'),'Completed treatment',503,'Cetirizine',to_date('13-NOV-25','DD-MON-RR'),'10mg','Cetirizine','Blood Test');
REM INSERTING into SYSTEM.PRESCRIPTIONS
SET DEFINE OFF;
...
SET DEFINE OFF;
REM INSERTING into SYSTEM.SUPPLIER_MASTER
SET DEFINE OFF;
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (1,'MedPlus Pharma','MedPlus Pvt Ltd','info@medplus.com','9876543210','Active',to_date('20-MAR-24','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (2,'Apollo Distributors','Apollo Healthcare Ltd','sales@apollo.com','9876501234','Active',to_date('15-APR-24','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (3,'CureWell Supplies','CureWell Pharma','support@curewell.com','9988776655','Active',to_date('10-MAY-24','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (4,'SunCare Distributors','SunCare Pharma Ltd','contact@suncare.com','9123456789','Inactive',to_date('05-JUN-24','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (5,'LifeLine Traders','LifeLine Drugs Pvt Ltd','sales@lifeline.com','9784512369','Active',to_date('01-JUL-24','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
Insert into SYSTEM.SUPPLIER_MASTER (SUPPLIER_ID,SUPLIER_NAME,COMPANY_NAME,S_EMAIL,S_CONTACT,S_STATUS,SUPALY_DATE,CREATED_AT,UPDATED_AT) values (6,'Apollo CUSTOMER','Apollo Healthcare Pvt Ltd','apollo@gmail.com','9876543210','Active',to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'),to_date('28-OCT-25','DD-MON-RR'));
REM INSERTING into SYSTEM.USERS
SET DEFINE OFF;
Insert into SYSTEM.USERS (ID,FULL_NAME,EMAIL,MOBILE,PASSWORD) values (1,null,'vamsi@gmail.com',null,null);
REM INSERTING into SYSTEM.USER_MASTER
SET DEFINE OFF;
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (1,'krishna','9998877664','bvamsi0103@gmail.com','1234-1111-1111','Guntur, AP','Nurses','medical',45000,to_date('10-FEB-21','DD-MON-RR'),'7 AM - 3 PM',0,'11112222',1,null,null,105);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (2,'EizXcacAC','9887766554','eswarimadhavarapu@gmail.com','1234-2222-2222','Vijayawada, AP','Admin','superadmin',32000,to_date('05-JAN-22','DD-MON-RR'),'8 AM - 4 PM',0,'11112222',null,null,null,89);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (3,'Manisha Rao','9876554433','sunilsaisomasi@gmail.com','1234-3333-3333','Hyderabad, TS','admin','admin',30000,to_date('15-MAR-23','DD-MON-RR'),'10 AM - 6 PM',0,'11112222',1,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (4,'Lakshmi Priya','9812345678','lakshmi.priya@hospital.com','1234-4444-4444','Tirupati, AP','Nurses','Assistant Nurse',28000,to_date('10-JUN-23','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (5,'Meena Sharma','9123456780','pstesting733@gmail.com','2234-5555-5555','Mumbai, MH','Pharmacy','admin',40000,to_date('01-MAR-23','DD-MON-RR'),'10 AM - 6 PM',0,'11112222',null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (6,'Rahul Verma','9823456710','rahul.verma@hospital.com','2234-6666-6666','Pune, MH','Pharmacy','Pharmacy Assistant',28000,to_date('15-AUG-22','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (7,'Priyanka Nair','9765432109','priyanka.nair@hospital.com','2234-7777-7777','Ernakulam, KL','Pharmacy','Inventory Manager',35000,to_date('20-DEC-21','DD-MON-RR'),'8 AM - 4 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (8,'Ravi Teja','9678123456','ravi.teja@hospital.com','2234-8888-8888','Vijayawada, AP','Pharmacy','Cashier',22000,to_date('01-JUL-23','DD-MON-RR'),'10 AM - 6 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (9,'Pooja Singh','9998123456','pooja.singh@hospital.com','3234-1111-2222','Delhi, DL','Reception','Front Desk Executive',30000,to_date('01-OCT-21','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (10,'Vikas Yadav','9988776655','vikas.yadav@hospital.com','3234-2222-3333','Lucknow, UP','Reception','Receptionist',27000,to_date('20-NOV-22','DD-MON-RR'),'8 AM - 4 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (11,'Anjali Menon','9876543201','anjali.menon@hospital.com','3234-3333-4444','Kochi, KL','Reception','Customer Support',26000,to_date('12-FEB-23','DD-MON-RR'),'10 AM - 6 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (12,'Amit Sharma','9812345000','amit.sharma@hospital.com','3234-4444-5555','Bangalore, KA','Reception','Coordinator',31000,to_date('18-MAY-22','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (13,'Ramesh Naidu','9876012345','ramesh.naidu@hospital.com','4234-1111-1111','Vijayawada, AP','Cleaning','Janitor',18000,to_date('20-JUN-22','DD-MON-RR'),'6 AM - 2 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (14,'Suresh Kumar','9123450987','suresh.kumar@hospital.com','4234-2222-2222','Guntur, AP','Cleaning','Floor Cleaner',17500,to_date('25-JAN-23','DD-MON-RR'),'7 AM - 3 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (15,'Radha Devi','9988771122','radha.devi@hospital.com','4234-3333-3333','Vizag, AP','Cleaning','Sanitation Worker',18500,to_date('12-SEP-22','DD-MON-RR'),'6 AM - 2 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (16,'Anand Patel','9887654321','anand.patel@hospital.com','4234-4444-4444','Surat, GJ','Cleaning','Waste Management',19000,to_date('01-APR-23','DD-MON-RR'),'6 AM - 2 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (57,'sdfghj','5342672178','dsfgh@gmail.com','524216512562','sghhsjjkkks ghshjjkkskllkls','Orthopedics','Owner',null,to_date('26-NOV-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-N0O8VL',1,'JSFSG5342G','dfghjk',83);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (18,'Neha Jain','9823456789','neha.jain@hospital.com','5234-2222-2222','Delhi, DL','Lab','Pathology Assistant',32000,to_date('10-MAR-22','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (19,'Sanjay Rao','9912345678','sanjay.rao@hospital.com','5234-3333-3333','Chennai, TN','Lab','Sample Collector',25000,to_date('14-MAY-23','DD-MON-RR'),'7 AM - 3 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (20,'Divya Gupta','9876123450','divya.gupta@hospital.com','5234-4444-4444','Delhi, DL','Lab','Microbiologist',42000,to_date('05-NOV-20','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (21,'Rajesh Kumar','9877012345','rajesh.kumar@hospital.com','6234-1111-1111','Hyderabad, TS','Security','Head Guard',25000,to_date('15-APR-21','DD-MON-RR'),'8 PM - 6 AM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (22,'Mohan Singh','9123409876','mohan.singh@hospital.com','6234-2222-2222','Delhi, DL','Security','Guard',20000,to_date('01-AUG-22','DD-MON-RR'),'8 PM - 6 AM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (23,'Pavan Reddy','9987601234','pavan.reddy@hospital.com','6234-3333-3333','Vijayawada, AP','Security','Night Guard',21000,to_date('10-JAN-23','DD-MON-RR'),'9 PM - 5 AM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (24,'Kishore Kumar','9812312345','kishore.kumar@hospital.com','6234-4444-4444','Chennai, TN','Security','Day Guard',19500,to_date('25-OCT-22','DD-MON-RR'),'8 AM - 6 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (25,'Naveen Kumar','9876543211','naveen.kumar@hospital.com','7234-1111-1111','Guntur, AP','Maintenance','Electrician',28000,to_date('15-MAY-22','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (26,'Ravi Shankar','9123498765','ravi.shankar@hospital.com','7234-2222-2222','Hyderabad, TS','Maintenance','Plumber',26000,to_date('01-DEC-21','DD-MON-RR'),'8 AM - 4 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (27,'Sunil Patil','9823109876','sunil.patil@hospital.com','7234-3333-3333','Pune, MH','Maintenance','Technician',30000,to_date('01-JUN-23','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (28,'Mahesh Babu','9998123098','mahesh.babu@hospital.com','7234-4444-4444','Vijayawada, AP','Maintenance','Lift Operator',24000,to_date('12-SEP-22','DD-MON-RR'),'8 AM - 4 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (29,'Arun Prasad','9876001234','arun.prasad@hospital.com','7234-5555-5555','Chennai, TN','Maintenance','AC Mechanic',27000,to_date('20-FEB-23','DD-MON-RR'),'9 AM - 5 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (30,'Vinod Reddy','9876540987','vinod.reddy@hospital.com','7234-6666-6666','Hyderabad, TS','Maintenance','Generator Operator',25000,to_date('25-APR-22','DD-MON-RR'),'8 AM - 4 PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (31,'Anitha Rao','9876543210','anitha.rao@healthcare.com','123456789012','Vijayawada','Nursing','Head Nurse',18500,to_date('10-MAY-23','DD-MON-RR'),'8AM - 4PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (33,'Anitha Rao','9876543210','anitha.rao@healthcare.com','123456789042','Vijayawada','Nursing','Head Nurse',18500,to_date('10-MAY-23','DD-MON-RR'),'8AM - 4PM',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (41,'Dr. Krishna','9876543210','krishna@example.com','123456780002','Vijayawada, Andhra Pradesh','Cardiology','Doctor',75000,to_date('04-NOV-25','DD-MON-RR'),'10:00 AM - 6:00 PM',0,'securePassword123',1,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (42,'kalpana','123232323','pavansanthosh733@gmail.com','123232323','wertyjhcvbk','Nursing','laboratory',23000,to_date('15-NOV-25','DD-MON-RR'),'9 to 10',0,null,null,null,null,null);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (74,'Naga','9666584155','nagaswathikadali@gmail.com','280238184424','Poranki, Tadigadapa, Penamaluru, Krishna district','Administration','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-FY9D2V',1,'JGSFA6544A','Director',232);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (72,'swathi','9666584155','swathikadali32567@gmail.com','280238181416','Poranki, Tadigadapa, Penamaluru, Krishna district','Ophthalmology','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-58PN1X',1,'KJSGR7563L','owner',228);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (73,'monika','9666584165','swathi32567@gmail.com','280238181765','KG Gupta Municipal Employees Colony, Labbipet, Vijayawada, Vijayawada (Urban), NTR, Andhra Pradesh, 520001, India','ENT','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-Z3KMUU',1,'KJUGR7563L','owner',231);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (75,'monikanagaswathi','9876543276','monikanagaswathikadali@gmail.com','284358184542','Poranki, Tadigadapa, Penamaluru, Krishna district','ENT','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-GJL9EM',1,'JGSFA6844A','owner',234);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (76,'jjhggffff','9899543276','monikana@gmail.com','284358184567','Poranki, Tadigadapa, Penamaluru, Krishna district','Radiology','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-8K7Z4S',1,'JGSFA6844D','owner',235);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (77,'kadalimonikanagaswathi','9878677546','eswarimadavarapu@gmail.com','876406368075','Poranki, Tadigadapa, Penamaluru, Krishna district','General Surgery','Owner',null,to_date('06-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'11112222',1,'JNDYG6543F','Director',236);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (78,'pavan','8886261806','nidubrolupavan@gmail.com','532566326773','KG Gupta Municipal Employees Colony, Labbipet, Vijayawada, Vijayawada (Urban), NTR, Andhra Pradesh, 520001, India','ENT','Owner',null,to_date('12-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-2Y3LI5',1,'JGDBS6452H','Director',243);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (79,'hggdshsd','6728276365','jsdhdgf@gmail.com','874655651272','HJSDWEGHGHWE','Neurology','Owner',null,to_date('12-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-ZEI2FJ',1,'JDHET8352K','jhdhgwyuew',244);
Insert into SYSTEM.USER_MASTER (ID,FULL_NAME,MOBILE_NUMBER,EMAIL_ID,AADHAR_NUMBER,ADDRESS,DEPARTMENT,ROLE,SALARY,JOINING_DATE,SHIFT_TIMINGS,LOGIN_ATTEMPTS,PASSWORD,TWO_FACTOR_AUTHENTICATION,PAN_NUMBER,DESIGNATION,ORGANIZATION_ID) values (80,'bhavani','7794023919','bhavanigojula2001@gmail.com','398058917119','KG Gupta Municipal Employees Colony, Labbipet, Vijayawada, Vijayawada (Urban), NTR, Andhra Pradesh, 520001, India','Gynecology','Owner',null,to_date('13-DEC-25','DD-MON-RR'),'9AM - 6PM',0,'HSPL-CWHEKF',1,'KHRSG8856J','owner',247);
REM INSERTING into SYSTEM.WARD_MASTER
SET DEFINE OFF;
Insert into SYSTEM.WARD_MASTER (WARD_ID,WARD_NAME,WARD_TYPE,TOTAL_BEDS,CREATED_ON) values (3,'icu2','ICU',5,to_date('25-OCT-25','DD-MON-RR'));
Insert into SYSTEM.WARD_MASTER (WARD_ID,WARD_NAME,WARD_TYPE,TOTAL_BEDS,CREATED_ON) values (2,'General Ward B','General',8,to_date('17-OCT-25','DD-MON-RR'));
Insert into SYSTEM.WARD_MASTER (WARD_ID,WARD_NAME,WARD_TYPE,TOTAL_BEDS,CREATED_ON) values (1,'General Ward A','General',10,to_date('17-OCT-25','DD-MON-RR'));
Insert into SYSTEM.WARD_MASTER (WARD_ID,WARD_NAME,WARD_TYPE,TOTAL_BEDS,CREATED_ON) values (4,'ICU Ward','ICU',10,to_date('22-OCT-25','DD-MON-RR'));
Insert into SYSTEM.WARD_MASTER (WARD_ID,WARD_NAME,WARD_TYPE,TOTAL_BEDS,CREATED_ON) values (5,'normal','General',44,to_date('22-OCT-25','DD-MON-RR'));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_USER_MASTER
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_USER_MASTER" ON "SYSTEM"."USER_MASTER" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_VERIFICATION_LEVEL
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_VERIFICATION_LEVEL" ON "SYSTEM"."HOSPITALS_MEDICALSTORES" ("VERIFICATION_LEVEL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" ) ;
--------------------------------------------------------
--  DDL for Index IDX_TYPE
--------------------------------------------------------

  CREATE INDEX "SYSTEM"."IDX_TYPE" ON "SYSTEM"."HOSPITALS_MEDICALSTORES" ("TYPE") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" MODIFY ("ORDER_ITEM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" ADD PRIMARY KEY ("ORDER_ITEM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table HTE_APPOINTMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HTE_APPOINTMENTS" MODIFY ("RN_" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HTE_APPOINTMENTS" ADD PRIMARY KEY ("RN_") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."USER_MASTER" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USER_MASTER" MODIFY ("FULL_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USER_MASTER" MODIFY ("MOBILE_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."USER_MASTER" ADD CONSTRAINT "PK_USER_MASTER" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."USER_MASTER" ADD UNIQUE ("AADHAR_NUMBER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER_PAYMENTS" MODIFY ("PAYMENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_PAYMENTS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_PAYMENTS" ADD PRIMARY KEY ("PAYMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table LAB_CATEGORY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LAB_CATEGORY" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_CATEGORY" MODIFY ("CATEGORY_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_CATEGORY" ADD PRIMARY KEY ("CATEGORY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PATIENTS" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PATIENTS" ADD PRIMARY KEY ("PATIENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."PATIENTS" ADD UNIQUE ("AADHAR")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."APPOINTMENTS" MODIFY ("APPOINTMENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."APPOINTMENTS" MODIFY ("DOCTOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."APPOINTMENTS" MODIFY ("SLOT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."APPOINTMENTS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."APPOINTMENTS" ADD PRIMARY KEY ("APPOINTMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" MODIFY ("ADDRESS_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" ADD PRIMARY KEY ("ORDER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MEDICINE" MODIFY ("MEDICINE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEDICINE" MODIFY ("MEDICINE_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEDICINE" ADD PRIMARY KEY ("MEDICINE_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
 ...
 (PARTITION "P_LESSTHAN100" NOCOMPRESS 
  ...
  TABLESPACE "SYSAUX" )  ENABLE;
--------------------------------------------------------
--  Constraints for Table WARD_MASTER
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."WARD_MASTER" MODIFY ("WARD_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."WARD_MASTER" MODIFY ("WARD_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."WARD_MASTER" MODIFY ("TOTAL_BEDS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."WARD_MASTER" ADD CHECK (ward_type IN ('General', 'ICU', 'Emergency', 'Private')) ENABLE;
  ALTER TABLE "SYSTEM"."WARD_MASTER" ADD PRIMARY KEY ("WARD_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table HOSPITALS_MEDICALSTORES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("TYPE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("ORGANIZATION_MAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("HOSPITAL_PHONE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("ADDRESS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("CITY" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("STATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" MODIFY ("PINCODE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" ADD UNIQUE ("CODE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" ADD UNIQUE ("ORGANIZATION_MAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."HOSPITALS_MEDICALSTORES" ADD UNIQUE ("HOSPITAL_PHONE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LAB_REPORT" MODIFY ("REPORT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_REPORT" MODIFY ("PATIENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_REPORT" MODIFY ("TEST_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_REPORT" ADD PRIMARY KEY ("REPORT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table ORGANIZATION_BANKDETAILS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("BANK_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("ORGANIZATION_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("ACCOUNT_HOLDER_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("ACCOUNT_NUMBER" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("IFSC_CODE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" MODIFY ("BANK_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" ADD CHECK (account_type IN ('Current','Savings')) ENABLE;
  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" ADD PRIMARY KEY ("BANK_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LAB_TEST" MODIFY ("TEST_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_TEST" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_TEST" MODIFY ("TEST_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LAB_TEST" ADD PRIMARY KEY ("TEST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DOCTORS" MODIFY ("DOCTOR_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DOCTORS" MODIFY ("SPECIALIZATION" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DOCTORS" ADD PRIMARY KEY ("DOCTOR_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DOCTORS" ADD UNIQUE ("PHONE")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DOCTORS" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."DOCTORS" ADD UNIQUE ("MEDICAL_LICENSE_NO")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."PRESCRIPTION" MODIFY ("DOCTOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTION" MODIFY ("DOSAGE_INSTRUCTIONS" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTION" MODIFY ("PATIENT_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTION" MODIFY ("SELECTED_MEDICINES" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTION" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."DOCTOR_AVAILABILITY" MODIFY ("DOCTOR_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DOCTOR_AVAILABILITY" MODIFY ("SLOT_DATE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."DOCTOR_AVAILABILITY" ADD PRIMARY KEY ("SLOT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."SUPPLIER_MASTER" MODIFY ("SUPPLIER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUPPLIER_MASTER" MODIFY ("SUPLIER_NAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SUPPLIER_MASTER" ADD PRIMARY KEY ("SUPPLIER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER_CART" MODIFY ("CART_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_CART" MODIFY ("USER_ID" NOT NULL ENABLE);
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
  ALTER TABLE "SYSTEM"."CUSTOMER_CART" ADD UNIQUE ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" MODIFY ("REVIEW_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" MODIFY ("MEDICINE_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" ADD CHECK (RATING BETWEEN 1 AND 5) ENABLE;
  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" ADD PRIMARY KEY ("REVIEW_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."LOGIN_DETAILS" MODIFY ("EMAIL" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_DETAILS" MODIFY ("PASSWORD" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_DETAILS" MODIFY ("ROLE" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."LOGIN_DETAILS" ADD UNIQUE ("EMAIL")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."CUSTOMER_ADDRESSES" MODIFY ("ADDRESS_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ADDRESSES" MODIFY ("USER_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_ADDRESSES" ADD PRIMARY KEY ("ADDRESS_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Constraints for Table CUSTOMER_CART_ITEMS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" MODIFY ("CART_ITEM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" MODIFY ("CART_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" MODIFY ("ITEM_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" ADD PRIMARY KEY ("CART_ITEM_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Constraints for Table HTE_DOCTOR_AVAILABILITY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."HTE_DOCTOR_AVAILABILITY" MODIFY ("RN_" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."HTE_DOCTOR_AVAILABILITY" ADD PRIMARY KEY ("RN_") ENABLE;
--------------------------------------------------------
--  Constraints for Table PRESCRIPTIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRESCRIPTIONS" MODIFY ("PRESCRIPTION_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTIONS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."PRESCRIPTIONS" ADD PRIMARY KEY ("PRESCRIPTION_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table BED_BOOKING
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."BED_BOOKING" ADD CONSTRAINT "FK_BED_BOOKING_WARD" FOREIGN KEY ("WARD_ID")
	  REFERENCES "SYSTEM"."WARD_MASTER" ("WARD_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_ADDRESSES
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_ADDRESSES" ADD CONSTRAINT "FK_CUST_ADDR" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."USER_MASTER" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_CART
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_CART" ADD CONSTRAINT "FK_CART_CUST" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."USER_MASTER" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_CART_ITEMS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_CART_ITEMS" ADD CONSTRAINT "FK_CART_ITEMS" FOREIGN KEY ("CART_ID")
	  REFERENCES "SYSTEM"."CUSTOMER_CART" ("CART_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_ORDERS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" ADD CONSTRAINT "FK_ORDERS_CUST" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."USER_MASTER" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."CUSTOMER_ORDERS" ADD CONSTRAINT "FK_ORDERS_ADDR" FOREIGN KEY ("ADDRESS_ID")
	  REFERENCES "SYSTEM"."CUSTOMER_ADDRESSES" ("ADDRESS_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_ORDER_ITEMS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_ORDER_ITEMS" ADD CONSTRAINT "FK_ORDITEM_ORDER" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."CUSTOMER_ORDERS" ("ORDER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER_PAYMENTS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."CUSTOMER_PAYMENTS" ADD CONSTRAINT "FK_PAY_ORDER" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."CUSTOMER_ORDERS" ("ORDER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DOCTOR_AVAILABILITY
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."DOCTOR_AVAILABILITY" ADD CONSTRAINT "FK_DOC_AVAIL" FOREIGN KEY ("DOCTOR_ID")
	  REFERENCES "SYSTEM"."DOCTORS" ("DOCTOR_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LAB_REPORT
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LAB_REPORT" ADD CONSTRAINT "FK_PATIENT_LAB" FOREIGN KEY ("PATIENT_ID")
	  REFERENCES "SYSTEM"."PATIENTS" ("PATIENT_ID") ENABLE;
  ALTER TABLE "SYSTEM"."LAB_REPORT" ADD CONSTRAINT "FK_LAB_TEST" FOREIGN KEY ("TEST_ID")
	  REFERENCES "SYSTEM"."LAB_TEST" ("TEST_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table LAB_TEST
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."LAB_TEST" ADD CONSTRAINT "FK_LAB_CATEGORY" FOREIGN KEY ("CATEGORY_ID")
	  REFERENCES "SYSTEM"."LAB_CATEGORY" ("CATEGORY_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MEDICINE
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MEDICINE" ADD CONSTRAINT "FK_SUPPLIER" FOREIGN KEY ("SUPPLIER_ID")
	  REFERENCES "SYSTEM"."SUPPLIER_MASTER" ("SUPPLIER_ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table MEDICINE_REVIEWS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."MEDICINE_REVIEWS" ADD CONSTRAINT "FK_REVIEW_CUST" FOREIGN KEY ("ID")
	  REFERENCES "SYSTEM"."USER_MASTER" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."MVIEW$_ADV_ROLLUP" ADD CONSTRAINT "MVIEW$_ADV_ROLLUP_PFK" FOREIGN KEY ("RUNID#", "PLEVELID#")
	  REFERENCES "SYSTEM"."MVIEW$_ADV_LEVEL" ("RUNID#", "LEVELID#") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORGANIZATION_BANKDETAILS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."ORGANIZATION_BANKDETAILS" ADD CONSTRAINT "FK_ORG_BANK" FOREIGN KEY ("ORGANIZATION_ID")
	  REFERENCES "SYSTEM"."HOSPITALS_MEDICALSTORES" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRESCRIPTIONS
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."PRESCRIPTIONS" ADD CONSTRAINT "FK_PRES_CUST" FOREIGN KEY ("ID")
	  REFERENCES "SYSTEM"."USER_MASTER" ("ID") ENABLE;
  ALTER TABLE "SYSTEM"."PRESCRIPTIONS" ADD CONSTRAINT "FK_PRES_ORDER" FOREIGN KEY ("ORDER_ID")
	  REFERENCES "SYSTEM"."CUSTOMER_ORDERS" ("ORDER_ID") ENABLE;
