...
const finalApprovedRes = await HospitalAPI.getFinalApprovedStores();
const rejectedRes = await HospitalAPI.getRejectedStores();

const finalApproved = finalApprovedRes.data.data || [];
const rejected = rejectedRes.data.data || [];

const allStores = [...finalApproved, ...rejected];
